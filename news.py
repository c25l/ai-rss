...
class News:
    def __init__(self, use_clustering=True, use_louvain=False, use_tfidf=False):
        self.use_clustering = use_clustering
        self.clusterer = ArticleClusterer(use_louvain=use_louvain, use_tfidf=use_tfidf) if use_clustering else None
        self.claude = Copilot()
